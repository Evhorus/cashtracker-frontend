...
const buttonVariants = cva(
  // Native <button> elements default to cursor:default in browsers (only
  // <a href> gets pointer for free) - without cursor-pointer here, every
  // button in the app looked non-interactive on hover.
